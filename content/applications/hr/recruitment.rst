...
a pre-selected template as soon as an applicant's card enters a stage. These automated emails are
...
lower right section of the window. There are several pre-configured email templates to choose from.
